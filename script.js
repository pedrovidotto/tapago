document.addEventListener('DOMContentLoaded', () => {
    ...
    const carregarProgresso = () => { progresso = JSON.parse(localStorage.getItem('minhaRotinaMinimalInterativaFinalV3')) || {}; };
    const salvarProgresso = () => { localStorage.setItem('minhaRotinaMinimalInterativaFinalV3', JSON.stringify(progresso)); };
